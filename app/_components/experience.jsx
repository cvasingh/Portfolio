  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        ...
        <h2
          className={`text-timberWolf font-black md:text-[60px] sm:text-[48px] xs:text-[40px] text-[30px] font-poppins sm:pl-16 pl-[2rem]`}
        >
          Work Experience
        </h2>
      </motion.div>
      ...
      <div className="mt-20 flex flex-col">
        <VerticalTimeline className="vertical-timeline-custom-line">
          ...
          <VerticalTimelineElement
            ...
            icon={
              <div className="flex justify-center items-center w-full h-full">
                <Image src={resume} alt="resume" className="w-[45%] h-[45%] object-contain" />
              </div>
            }
          >
            <button
